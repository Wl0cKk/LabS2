...
Item items[] = {{"display", 160}, {"keyboard", 101}, {"mouse", 222}, {"motherboard", 900}, {"power supply", 550}, {"cpu", 180}, {"gpu", 150}, {"case", 132}};
...
int main() {
    ...
    Item* newItem = create_item("floppy-disk", 50);
