...
void solveTask(struct Student *students, int totalStudents) {
    ...
    fprintf(file, "-----------------------------------------------------------------------------------\n");
    for (int i = 0; i < totalStudents; i++) {
        if ((students[i].computerScienceGrade == 9) || (students[i].computerScienceGrade == 10)) {
            char *res = "Last name: %s, Group: %d, programming grade: %d GPA: %.2f\n";
            printf(res, students[i].lastname, students[i].groupNumber, students[i].computerScienceGrade, students[i].averageGrade);
            fprintf(file, res, students[i].lastname, students[i].groupNumber, students[i].computerScienceGrade, students[i].averageGrade);
        }
    }
